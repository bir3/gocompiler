...
import (
	"r2.is/gocompiler/src/cmd/gocmd/internal/workcmd"
	"context"
	...
	"r2.is/gocompiler/src/cmd/gocmd/internal/bug"
	"r2.is/gocompiler/src/cmd/gocmd/internal/cfg"
	"r2.is/gocompiler/src/cmd/gocmd/internal/clean"
	"r2.is/gocompiler/src/cmd/gocmd/internal/doc"
	"r2.is/gocompiler/src/cmd/gocmd/internal/envcmd"
	"r2.is/gocompiler/src/cmd/gocmd/internal/fix"
	"r2.is/gocompiler/src/cmd/gocmd/internal/fmtcmd"
	"r2.is/gocompiler/src/cmd/gocmd/internal/generate"
	"r2.is/gocompiler/src/cmd/gocmd/internal/get"
	"r2.is/gocompiler/src/cmd/gocmd/internal/help"
	"r2.is/gocompiler/src/cmd/gocmd/internal/list"
	"r2.is/gocompiler/src/cmd/gocmd/internal/modcmd"
	"r2.is/gocompiler/src/cmd/gocmd/internal/modfetch"
	"r2.is/gocompiler/src/cmd/gocmd/internal/modget"
	"r2.is/gocompiler/src/cmd/gocmd/internal/modload"
	"r2.is/gocompiler/src/cmd/gocmd/internal/run"
	"r2.is/gocompiler/src/cmd/gocmd/internal/test"
	"r2.is/gocompiler/src/cmd/gocmd/internal/tool"
	"r2.is/gocompiler/src/cmd/gocmd/internal/trace"
	"r2.is/gocompiler/src/cmd/gocmd/internal/version"
	"r2.is/gocompiler/src/cmd/gocmd/internal/vet"
