...
// If the package is a command (package gocmd), the exported symbols of the package
...
// 	-cmd
// 		Treat a command (package gocmd) like a regular package.
// 		Otherwise package gocmd's exported symbols are hidden
